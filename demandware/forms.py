...
class UploadFileForm(forms.Form):
	...
	header_row = forms.IntegerField(min_value=0, max_value=1048576, label='Header Row (Ex: 31)', initial=31)
	from_row = forms.IntegerField(min_value=0, max_value=1048576, label='From Row (Ex: 32)', initial=32)
