...
def insert_bulk_product_master(data=None):
	...
	try:
		...
		for item in data:
			obj = None
			print('ProductID: ', item['product_id'])
			obj = None
			try:
	...
	try:
		for item in data:
			try:
				...
				result['message'].append("[SKIP] ProductMaster DoesNotExist: " + item['product_id'] + "/" + item['variation_jan'])
	...
	try:
		...
		for item in data:
			try:
				...
				result['message'].append("[DUP] Image: " + item['product_id'] + '/' + item['product_image'])
			except ProductMaster.DoesNotExist:
				result['message'].append("[SKIP] ProductMaster DoesNotExist: " + item['product_id'])
				print("[SKIP] ProductMaster DoesNotExist!", item['product_id'])
				continue
